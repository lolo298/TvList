...
<table>
    <tbody>
        <tr>
            <td class="gauche"><p class="title">Temps passé devant des séries :</p><p class="data">{seriesWatchTime}</p></td>
            <td class="droite"><p class="title">Temps passé devant des films :</p><p class="data">{moviesWatchTime}</p></td>
        </tr>
        <tr>
            <td class="gauche"><p class="title">Nombre d'épisodes vus :</p><p class="data">{stats.seriesWatched}</p></td>
            <td class="droite"><p class="title">Nombre de films vus :</p><p class="data">{stats.moviesWatched}</p></td>
        </tr> 
    </tbody>
</table>
